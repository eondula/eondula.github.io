document.addEventListener("DOMContentLoaded", function() {
    ...
    function showContent(contentType) {
        ...
        switch (contentType) {
            ...
            Her research interests are diverse, covering areas in Reinforcement Learning, Decision Science, Uncertainty Quantification, Public Health, Multi-Agent Systems and Robotics. She also organizes a weekly reinforcement learning reading group <a href="https://suitersrl.github.io/">SUITERS-RL</a>
            </p>
<!--            <p>-->
